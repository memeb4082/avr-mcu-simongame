...
void pwm_init()
{
	// Set timer control b to single slope mode and compare with cmp0
...
{
	/*
	1ms tcb0 (gameplay timer) 4ms tcb1 (push buttons)
	*/
	TCB0.CCMP = 3333;
...
void uart_init()
{
	USART0.BAUD = (4 * F_CPU) / (BR); // baud rate set at full duplex
